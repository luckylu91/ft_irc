...
void	Io_manager::new_connection(Server * server)
{
...
void	Io_manager::incoming_message(Server * server, struct kevent tevent)
{
...
void	Io_manager::add_message_to_fd(Client const *  client, Message const &  message)
{
...
void	Io_manager::sending_message(struct kevent tevent)
{
	int n;
