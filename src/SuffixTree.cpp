...
// 	srand(time(NULL));
// 	SuffixTree tri;
// 	// std::cout << tri.select_random_word_with_prefix("ab") << std::endl;
// 	std::vector<std::string> lines;
// 	extract_lines("../liste_mots.txt", &lines);
// 	std::cout << lines.size() << std::endl;
// 	for (int i = 0; i < lines.size(); i++)
// 		tri.add_string(lines[i]);
// 	std::cout << "END OF ADD" << std::endl;
// 	std::cout << "tri.get_weight() = " << tri.get_weight() << std::endl;
// 	while (true) {
// 		for (char c = 'a'; c <= 'z'; c++) {
// 			std::string prefix;
// 			prefix.push_back(c);
// 			std::cout << tri.select_random_word_with_prefix(prefix) << std::endl;
// 		}
// 	}
// }
